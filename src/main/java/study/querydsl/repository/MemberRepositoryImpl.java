...
public class MemberRepositoryImpl implements MemberRepositoryCustom {
    ...
    public Page<MemberTeamDto> searchPageComplex(MemberSearchCondition condition, Pageable pageable) {
        ...
        JPAQuery<Member> coutQuery = queryFactory
                .select(member)
                .from(member)
                .leftJoin(member.team, team)
                .where(usernameEq(condition.getUsername()),
        ...
        // 첫번째 페이지 일때 전체 content사이즈가 페이지 사이즈보다 작을 떄, 마지막 페이지일떄 count쿼리가 없어도 되므로 PageableExecutionUtis가 그걸 해준다.
        return PageableExecutionUtils.getPage(content, pageable, () -> coutQuery.fetchCount());
    }
}
